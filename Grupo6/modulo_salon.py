...
class Modulo_salon:
    ...
    def execute_modulo(self):
        if(self.ans=='1'): #read list
            ...
            print("Ingrese la informacion solicitada registro que desea actulizar:")
            Numero=input("Numero: ")
            Seccion=input("Seccion: ")            
            list_op_nom=['Cambiar numero','Cambiar seccion']
            list_op_num=['1','2']
            menu_update_salon=menu.Menu('salon',list_op_nom,list_op_num)
            Field=menu_update_salon.show_menu()
            if (Field=='1'):
                field="numero"
            elif (Field=='2'):
                field="seccion"
